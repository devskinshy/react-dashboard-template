...
export const ListItemStyle = styled(Button, {
  shouldForwardProp: (prop) => prop !== 'activeRoot' && prop !== 'activeSub' && prop !== 'subItem' && prop !== 'toggle',
})(({ activeRoot, activeSub, subItem, toggle, theme }) => {
  ...
  return {
    ...
    height: theme.dashboard.NAVBAR.DASHBOARD_ITEM_HORIZONTAL_HEIGHT,
    '&:hover': {
